...
const O = "/assets/govbr-logo-DUdxlXZj.png"
  ...
  , xe = () => {
    ...
    const i = T()
      , r = $()
      , u = te(10)
      , {amount: d, pixKeyType: c, pixKey: x, customerData: a} = r.state || {
        amount: "10",
        pixKeyType: "email",
        pixKey: ""
    }
...
l.useEffect(() => {
    ...
    const n = t => `R$ ${t.toLocaleString("pt-BR", {
      ...
      , q = new Date().toLocaleDateString("pt-BR")
      , D = {
        cpf: "CPF",
        email: "E-mail",
        phone: "Celular",
        ...
        children: [e.jsxs("header", {
            ...
            children: [e.jsxs("div", {
                ...
                children: [e.jsx("p", {
                    ...
                    style: {
                        opacity: s ? 1 : 0,
                        transform: s ? "rotate(0deg) scale(1)" : "rotate(-90deg) scale(0.5)",
            ...
            children: [e.jsx("p", {
                ...
                children: [e.jsx("div", {
                    ...
                    children: [Z, H, G, ee].map( (t, f) => e.jsx("img", {
                        ...
                        alt: "",
                        loading: "lazy",
                        className: "w-[22px] h-[22px] rounded-full object-cover border-2 border-white",
                        style: {
